      ...
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Users</h3>
           <a data-target="#modal_name_form" data-toggle="modal" class="btn btn-flat bg-green wave waves-effect pull-right margin-r-5" href="#"><i class="fa fa-plus"></i><span class="hidden-xs">Add User</span></a>
        </div><!-- /.box-header -->
...
<?php
//$userAddData['user']['all'] = $users;
?>
<?php $this->load->view('/admin/user/elements/modal_name_form');?>
...
$(document).ready(function () {
	    oTable = $('#example2').DataTable({
            ...
            "sAjaxSource": '<?php echo base_url(); ?>admin/user/get_ajax_page_listing',
            "bJQueryUI": true,
