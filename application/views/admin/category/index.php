      ...
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">Categories</h3>
           <a data-target="#modal_name_form" data-toggle="modal" class="btn btn-flat bg-green wave waves-effect pull-right margin-r-5" href="#"><i class="fa fa-plus"></i><span class="hidden-xs">Add New Category</span></a>
        </div><!-- /.box-header -->
...
<?php
$categoryAddData['category']['all'] = $categories;
?>
<?php $this->load->view('/admin/category/elements/modal_name_form', $categoryAddData);?>
