...
<div class="modal fade" id="modal_name_form" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        ...
        <?php echo form_open_multipart('/admin/category/add', array('id' => "form_add_action", "enctype" => "multipart/form-data")); ?>
            <div class="modal-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <div class="wrap-validation">
                            <div class="check-val">
                                <?php //$category['all']['0'] = 'Top Level';  array_multisort($category['all']); ?>
                                <?php echo form_dropdown('parent_id', $category['all'], [], 'class="form-control"'); ?>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" id="btn_create_action" class="btn btn-success">Submit</button>
            </div>
        <?php echo form_close(); ?>
        </div>
    </div>
    ...
    $(function() {
       ...
       // var btn = $('#btn_create_action');
        ...
        btn.submit(function() {
            ...
            var action_url = '<?php echo base_url("/admin/category/add") ?>';
