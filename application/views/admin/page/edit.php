...
<section class="content">
          ...
          <div  class="content">
            ...
            <div class="col-sm-6">
             ...
             <div class="col-sm-8">
                <textarea class="textarea form-control" name="content" id="content"  placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $result['content'] ?></textarea>
                <br>
             ...
             <div class="col-sm-6">
                <input type="radio" name="status" id="active_status" value="1" class="flat-red" <?php echo ($result['status'] == 1 ? 'checked' : '') ?>> Active
                <input type="radio" name="status" id="inactive_status" value="0" class="flat-red" <?php echo ($result['status'] == 0 ? 'checked' : '') ?>> Inactive
                <br>								
             </div>
             </div>    
