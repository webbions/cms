 <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><img height="30px" width="30px" src="<?php echo base_url("assets/images/favicon.png"); ?>" alt="webbions" /></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Webbions</b></span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="<?php echo base_url(); ?>admin/home/profile" class="btn btn-default btn-flat">Profile</a>
                    </div>
