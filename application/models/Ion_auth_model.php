...
class Ion_auth_model extends CI_Model
{
	 ...
	 * @author Mathew
	 **/
	public function login($identity, $password, $remember=FALSE, $byPassPassword = FALSE)
	{
		...
		if ($query->num_rows() === 1)
		{
			...
			// for social fix
			// if $byPassPassword == TRUE then do not check password, use only email/identity field for login
			if ( $byPassPassword ) {
				$password = TRUE;
			}
