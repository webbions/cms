...
class MahanaModel extends CI_Model
{
    /**
     * Send a New Message
     *
     ...
     * @return  array
     */
    function get_all_threads($user_id, $full_thread = FALSE, $order_by = 'asc',$limit = '')
    {
        ...
        $sql .= ' GROUP BY m.thread_id ORDER BY t.id ' . $order_by. ', m.cdate '. $order_by.$limit;
        $query = $this->db->query($sql, array($user_id, $user_id));
        return $query->result_array();
    }
	
	/***Forpagination**/
	function get_all_threads_pagination($user_id, $full_thread = FALSE, $order_by = 'asc',$limit = '')
    {
